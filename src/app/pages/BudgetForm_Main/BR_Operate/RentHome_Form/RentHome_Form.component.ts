...
@Component({
    selector: 'RentHome_Form',
    templateUrl: 'RentHome_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class RentHome_FormComponent implements OnInit {
    ...
    cal_rent_per_year_item(index: number) {
        debugger;
        let Total = this.List_Budget_Request_Detail_Item[index].Rent_Per_Month * 12
