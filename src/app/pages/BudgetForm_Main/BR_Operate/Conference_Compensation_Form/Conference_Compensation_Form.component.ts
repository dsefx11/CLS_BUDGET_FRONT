...
@Component({
    selector: 'Conference_Compensation_Form',
    templateUrl: 'Conference_Compensation_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class Conference_Compensation_FormComponent implements OnInit {
    ...
    cal_qty_item(Index: number) {
        let Total = (this.List_Budget_Request_Detail_Item[Index].People * this.List_Budget_Request_Detail_Item[Index].Qty_Month) * this.List_Budget_Request_Detail_Item[Index].Cost_Amount
