...
@Component({
    selector: 'Repair_Buildings_Form',
    templateUrl: 'Repair_Buildings_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class Repair_Buildings_FormComponent implements OnInit {
