...
@Component({
    selector: 'NurseFee_AfternoonAndNight_Form',
    templateUrl: 'NurseFee_AfternoonAndNight_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class NurseFee_AfternoonAndNight_FormComponent implements OnInit {
    ...
    cal_qty_item(data: any) {
        let Total = (data.Cost_Amount * data.People) * data.Qty_Night_Shift
        data.Total = Total;
