...
@Component({
    selector: 'PublicHealth_Compensation_Form',
    templateUrl: 'PublicHealth_Compensation_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class PublicHealth_Compensation_FormComponent implements OnInit {
