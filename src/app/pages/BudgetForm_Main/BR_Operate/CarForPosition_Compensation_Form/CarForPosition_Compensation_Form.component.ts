...
@Component({
    selector: 'CarForPosition_Compensation_Form',
    templateUrl: 'CarForPosition_Compensation_Form.component.html',
    styleUrls: ["../BR_Operate.component.scss"],
    providers: [GridJsService, DecimalPipe, EbudgetService],
})

export class CarForPosition_Compensation_FormComponent implements OnInit {
    ...
    cal_qty_item(index: number) {
        let Total = (this.List_Budget_Request_Detail_Item[index].Quantity * this.List_Budget_Request_Detail_Item[index].Rent_Per_Month) * 12
        this.List_Budget_Request_Detail_Item[index].Rent_Per_Year = Total;
