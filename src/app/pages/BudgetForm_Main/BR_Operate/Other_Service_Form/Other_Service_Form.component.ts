...
@Component({
    selector: 'Other_Service_Form',
    templateUrl: 'Other_Service_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class Other_Service_FormComponent implements OnInit {
    ...
    cal_Amont_item(data: any) {
        let Total = 0;
        Total = (data.Quantity * data.Qty_Month) * data.Cost_Amount
        data.Total = Total;
