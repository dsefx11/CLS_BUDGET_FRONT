...
@Component({
    selector: 'General_Compensation_Form',
    templateUrl: 'General_Compensation_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Operate.component.scss'],
})

export class General_Compensation_FormComponent implements OnInit {
