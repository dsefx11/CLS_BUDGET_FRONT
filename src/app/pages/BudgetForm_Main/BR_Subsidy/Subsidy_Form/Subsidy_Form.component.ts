...
@Component({
    selector: 'Subsidy_Form',
    templateUrl: 'Subsidy_Form.component.html',
    providers: [GridJsService, DecimalPipe, EbudgetService],
    styleUrls: ['../BR_Subsidy.component.scss'],
})

export class Subsidy_FormComponent implements OnInit {
    ...
    cal_qty_item(data: any) {
        let Total = (data.Qty_Month * data.Quantity) * data.Cost_Amount
        data.Total = Total;
