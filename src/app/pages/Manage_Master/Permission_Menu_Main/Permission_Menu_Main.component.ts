...
@Component({
    selector: 'Permission_Menu_Main',
    templateUrl: './Permission_Menu_Main.component.html',
    // styleUrls: ['./Permission_Menu_Main.component.css'],
    providers: [MasterService, GridJsService, DecimalPipe, EbudgetService]
})


export class Permission_Menu_MainComponent {
