...
import { MasterManageRoutingModule } from './Master_Manage-routing.module';
...
@NgModule({
    declarations: [
        Permission_Menu_MainComponent,
        Manage_Permission_GroupComponent,
    ],
    imports: [
        CommonModule,
        FormsModule,
...
export class Manage_MasterModule {
    constructor() {
